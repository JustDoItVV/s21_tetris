...
START_TEST(tc_ok_19) {
    ...
    isFieldEqual = params.data->field[params.figure->y][previousY] == 0;
    isFieldEqual = params.data->field[params.figure->y][previousY] == 0;
    isFieldEqual = params.data->field[FIELD_HEIGHT - 4][FIELD_HEIGHT / 2 - 1] == 1;
    isFieldEqual = params.data->field[FIELD_HEIGHT - 4][FIELD_HEIGHT / 2] == 1;
    isFieldEqual = params.data->field[FIELD_HEIGHT - 4][FIELD_HEIGHT / 2 + 1] == 1;
    isFieldEqual = params.data->field[FIELD_HEIGHT - 4][FIELD_HEIGHT / 2 + 2] == 1;
    ck_assert_int_eq(isFieldEqual, true);
}
END_TEST
...
START_TEST(tc_ok_31) {
    ...
    bool isFieldEqual = true;
    isFieldEqual = params.data->field[params.figure->y][params.figure->x - 1] == params.figure->type + 1;
    isFieldEqual = params.data->field[params.figure->y][params.figure->x] == params.figure->type + 1;
    isFieldEqual = params.data->field[params.figure->y][params.figure->x + 1] == params.figure->type + 1;
    isFieldEqual = params.data->field[params.figure->y][params.figure->x + 2] == params.figure->type + 1;
    ck_assert_int_eq(isFieldEqual, true);
}
END_TEST
...
START_TEST(tc_ok_34) {
    ...
    bool isFieldEqual = true;
    isFieldEqual = params.data->field[params.figure->y][params.figure->x - 1] == 0;
    isFieldEqual = params.data->field[params.figure->y][params.figure->x] == 0;
    isFieldEqual = params.data->field[params.figure->y][params.figure->x + 1] == 0;
    isFieldEqual = params.data->field[params.figure->y][params.figure->x + 2] == 0;
    ck_assert_int_eq(isFieldEqual, true);
}
END_TEST
